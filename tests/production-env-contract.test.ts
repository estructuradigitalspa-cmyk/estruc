...
describe("production environment contract",()=>{
  it("pins canonical public identifiers",()=>{for(const value of ["https://estructuradigital.cl","https://estructuradigital.cl/privacidad","https://estructuradigital.cl/terminos","https://estructuradigital.cl/eliminacion-de-datos","https://ocmcyhimhndlxlicojrs.supabase.co","1048232064232330","2487731658317049","2608678896249332","v26.0"])expect(script).toContain(value)});
